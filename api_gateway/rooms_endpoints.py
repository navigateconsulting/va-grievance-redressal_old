...
@sio.on('join_room', namespace='/grievance')
async def join_room(sid, room_name):
    print("________________________ User {} joined room {} with namespace /grievance_______________________".format(sid, room_name))
    sio.enter_room(sid, room=room_name, namespace='/grievance')
    sio.enter_room(sid, room=sid, namespace='/grievance')


@sio.on('leave_room', namespace='/grievance')
async def leave_room(sid, room_name):
    print("________________________ User {} Left room {} with namespace /grievance_______________________".format(sid, room_name))
    sio.leave_room(sid, room=room_name, namespace='/grievance')
    sio.leave_room(sid, room=sid, namespace='/grievance')

@sio.on('join_room', namespace='/agrievance')
async def join_room(sid, room_name):
    print("________________________ User {} joined room {} with namespace /grievance_______________________".format(sid, room_name))
    sio.enter_room(sid, room=room_name, namespace='/grievance')
    sio.enter_room(sid, room=sid, namespace='/grievance')
...
@sio.on('leave_room', namespace='/agrievance')
async def leave_room(sid, room_name):
    print("________________________ User {} Left room {} with namespace /grievance_______________________".format(sid, room_name))
    sio.leave_room(sid, room=room_name, namespace='/grievance')
    sio.leave_room(sid, room=sid, namespace='/grievance')